  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: ({ theme }: any) => ({
        ...
        'gradient-500-sm': `linear-gradient(145deg, ${theme('colors.primary-500')} 45%, ${theme('colors.secondary-500')} 49%, ${theme('colors.secondary-500')} 51%, ${theme('colors.primary-500')} 55%)`,
        'gradient-400-sm': `linear-gradient(145deg, ${theme('colors.primary-400')} 45%, ${theme('colors.secondary-400')} 49%, ${theme('colors.secondary-400')} 51%, ${theme('colors.primary-400')} 55%)`,
      }),
    },
  },
  plugins: [
