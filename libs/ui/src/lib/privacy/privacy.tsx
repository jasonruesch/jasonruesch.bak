...
export function Privacy() {
  ...
  return (
    <div className="flex flex-1 flex-col justify-center gap-4">
      ...
      <ul className="ml-4 list-disc pl-4 sm:text-xl">
        <li>
          Visit our website at{' '}
          <a
            className="font-medium text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-500"
      ...
      >
        ...
        <p>
          ...
          <a
            ...
            className="cursor-pointer text-primary-500 dark:text-primary-400"
      ...
      >
        <h2 className="text-xl font-medium sm:text-3xl">Table Of Contents</h2>
        <ol className="ml-4 list-decimal pl-4 sm:text-xl">
          {navItems.map((item) => (
            <li key={item.name}>
              <a
